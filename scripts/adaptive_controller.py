...
def make(sim,hand,dt):
    ...
    if not is_soft_hand:
        ...
        contact_sensors = f1_proximal_tactile_sensors + f1_distal_tactile_sensors + f2_proximal_tactile_sensors + f2_distal_tactile_sensors + f3_proximal_tactile_sensors + f3_distal_tactile_sensors
    ...
    def controlfunc(controller):
        ...
        if not is_soft_hand:
            ...
            try:
                f1_contact = [s.getMeasurements()[0] for s in f1_proximal_tactile_sensors] + [s.getMeasurements()[0] for s in f1_distal_tactile_sensors]
                f2_contact = [s.getMeasurements()[0] for s in f2_proximal_tactile_sensors] + [s.getMeasurements()[0] for s in f2_distal_tactile_sensors]
                f3_contact = [s.getMeasurements()[0] for s in f3_proximal_tactile_sensors] + [s.getMeasurements()[0] for s in f3_distal_tactile_sensors]
